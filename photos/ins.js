...
([
  ...
  function(module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      var ulTmpl = "";
      let urlPrex = "https://raw.githubusercontent.com/yongshangmoli/hexo-blog-imgs/master/";
      let defaultImg = urlPrex + 'empty.png'
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        var data = res.list[j].arr;
        var liTmpl = "";
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = urlPrex + data.link[i];
          var src = urlPrex + data.link[i];
          ...
          liTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope="" itemtype="http://schema.org/ImageObject">\
                <a href="' + src + '" itemprop="contentUrl" data-size="640x640" data-type="' + type + '" data-target="' + target + '">\
                  <img class="reward-img" data-type="' + type + '" data-src="' + src + '" src="'+ defaultImg +'" itemprop="thumbnail" onload="lzld(this)">\
                </a>\
